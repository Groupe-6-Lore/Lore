...
const RulesDetailsCreate = () => {
  ...
  // Données des règles avec extensions
  const rulesData = {
    'dnd-5e': {
      id: 'dnd-5e',
      name: 'D&D 5e',
      ...
      extensions: [
        {
          id: 'dnd-basic-rules',
          name: 'Règles de base',
          description: 'Les règles essentielles pour commencer à jouer à D&D 5e.',
          price: 0,
          included: true
        },
        {
          ...
          description: 'Classes, races et sorts complets pour créer des personnages variés.',
          price: 35,
          included: false
        },
        {
          ...
          description: 'Outils et conseils pour les MJ, tables de trésors et règles avancées.',
          price: 40,
          included: false
        },
        {
        ...
        {
          id: 'dnd-xanathar',
          name: 'Guide de Xanathar',
          description: 'Nouvelles classes, sorts et options de personnalisation.',
          price: 32,
          included: false
        }
      ]
    ...
    'fate-core': {
      ...
      extensions: [
        ...
        },
        {
          ...
          description: 'Version simplifiée et rapide de Fate.',
          price: 8,
          included: false
        }
      ]
    ...
    'symbaroum': {
      ...
      fullDescription: 'Symbaroum est un système de jeu de rôle qui combine simplicité et profondeur. Les règles sont faciles à apprendre mais offrent une grande richesse tactique. Le système met l\'accent sur l\'atmosphère, la corruption progressive des personnages, et les choix moraux difficiles. Parfait pour les joueurs qui aiment l\'horreur et le mystère.',
      ...
      extensions: [
        ...
        {
          id: 'symbaroum-throne',
          name: 'Le Trône de Throne',
          description: 'Campagne épique pour Symbaroum.',
          price: 45,
          included: false
        }
      ]
  ...
  useEffect(() => {
    if (!rule) {
      toast.error('Règles non trouvées');
  ...
  const handleUseRules = () => {
    ...
    localStorage.setItem('selectedRules', JSON.stringify(rulesData));
    
    toast.success(`${rule.name} sélectionné !`);
  ...
  const displayedExtensions = showAllExtensions ? rule.extensions : rule.extensions.slice(0, 3);
                  ...
                  {rule.extensions.length > 3 && (
                    ...
                    >
                      {showAllExtensions ? (
                        ...
                        <>
                          <Eye size={16} />
                          <span>Voir tout ({rule.extensions.length})</span>
                        </>
                      )}
                    </button>
                  )}
...
export default RulesDetailsCreate;
