              ...
              <div className="max-w-5xl">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <ChevronDown size={16} className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#552E1A] pointer-events-none" style={{ right: '12px' }} />
                      </div>
                    </div>
                ...
                <div className="flex justify-end gap-4 mt-4 pt-4 border-t border-[#552E1A]/20">
                  ...
                  <button
                    ...
                    disabled={!newCharacterName.trim() || !newCharacterCategory}
